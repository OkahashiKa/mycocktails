...
{ 
    /// <summary>
    /// Create user material api controller. 
    /// </summary>
    [ApiController]
    public class CreateUserMaterialController : CreateUserMaterialsApiController
    {
        private readonly ICreateUserMaterialLogic logic;
        private readonly ILogger<CreateUserMaterialController> logger;
        ...
        public CreateUserMaterialController(
            ICreateUserMaterialLogic logic,
            ILogger<CreateUserMaterialController> logger)
        {
            this.logic = logic;
            this.logger = logger;
        }
